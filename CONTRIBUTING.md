...
Before you report an issue, or wish to add cool functionality please try and check to see if there are existing [issues](https://github.com/jfdm/frigg/issues) and [pull requests](https://github.com/jfdm/frigg/pulls).
...
1. Fork the [main development repository](https://github.com/jfdm/frigg) on github e.g.
2. Clone your fork to your local machine:

```
$ git clone git@github.com/<your github user name>/frigg.git
```

3. Add `jfdm/frigg` as a remote upstream

```
$ git remote add upstream git@github.com:jfdm/frigg.git
```
...
1. Go to GitHub and submit a pull request to `frigg`
